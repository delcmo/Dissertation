...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This section aims at illustrating the theoretical approach developed in \sect{sec:ev_source_terms} for solving $1$-D flow with source terms using the EVM. All of the results presented in this section were obtained with the Relap7 code developed by Idaho National Laboratory (REF). Three source terms are considered: the wall-fraction force and the wall heat source that were detailed in \sect{sec:ev_source_terms}, and gravity terms, which yields the following $1$-D Euler equations:
%
\begin{subequations}
...
\end{table}
%
The first test consists of a flow with only wall-friction force and gravity terms. Then, a wall-heat source is added to the system and different values of the heat transfer coefficient $h_t$ are investigated. All of the previous tests are done for both vapor and liquid water phases. Lastly, a $1$-D core channel component from Relap7 is used to model the core of a Pressurized Water Reactor (PWR) for liquid water.
%---------------------------------------------------------------------------------------------------

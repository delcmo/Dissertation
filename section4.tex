...
%-------------------------------------------------------------------------------------------------------------------------------------------------
We still consider a $1$-D straight pipe of length $L=1$ $m$ filled with the same fluids as in \sect{sec:1d-advection-7-eq-sct4}. The velocity and pressure relaxation terms are set to zero so that the two fluid are independent. The left chamber of the pipe
%
\begin{figure}[H]
\centering

...
\end{equation}
% 
After multiplying by $\frac{\text{d} \eta (\alpha_k)}{\text{d} \alpha_k}$ and using the chain rule, an equation for the entropy residual $R_{\alpha,k}$ is obtained:
%

...
confirmed in~\cite{Berry_2010,Herrard_2005}.
...
gas equation of state (SGEOS)~\cite{Metayer_2004} was selected (as
...
LeMetayer~\cite{Metayer_2004} uses the saturation curves as this
...
in~\cite{Metayer_2004}.  The values for water and its vapor from that
...
of~\cite{Metayer_2004} is adopted.  This procedure for the

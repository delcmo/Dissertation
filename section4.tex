...
\end{equation}
%
Because the viscous regularization derived previously in \sect{sec:sev-equ-visc-reg-sect4} requires an extra viscosity coefficient $\beta_k$ for the volume fraction equation, a new P\'echlet number, $\Pe_{k,\infty}^\beta$ is also defined as follows,
%
\begin{equation}

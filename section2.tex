...
\tcr{try $\mbold{0}$ so that you do not keep vector arrows. it would be good to check throughout for vec in equations}
\begin{equation}
  \label{eqn:F}
...
\end{equation}
\tcr{what is $\Phi_{j}^e$?}\tcb{ It is $\phi$. I modified it}\tcr{shouldn't it be $s_j^e$?}

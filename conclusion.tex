...
As future work, extension to multi-dimensional numerical tests could be considered for both the seven-equation model and the radiation-hydrodynamic equations. 

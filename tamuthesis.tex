...
\newcommand{\chap}[1]{Section~\ref{#1}}                     % chapter
...
% trick to remove comments in order to generate draft version for committee members 
% \renewcommand{\tcr}[1]{\marginpar{\textcolor{white}{#1}}}
% \renewcommand{\tcb}[1]{\marginpar{\textcolor{white}{#1}}}
...
\renewcommand{\tamumanuscripttitle}{Extension of the Entropy Viscosity Method to the Multi-D Euler Equations and the Seven-Equation Two-Phase Model}
\renewcommand{\tamupapertype}{Dissertation}
\renewcommand{\tamufullname}{Marc Olivier Delchini}

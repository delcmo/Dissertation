...
\item System of equations that accurately describe the physical phenomena
...
\begin{frame}{$2$-D Mach $2.5$ flow over a forward facing step}
  \begin{columns}
    \column{.5\textwidth}
       \includemedia[addresource=forward_facing_step_density_movie.mp4, activate=pageopen, deactivate=pageclose, width=6.5cm, height=5cm, flashvars={source=forward_facing_step_density_movie.mp4 & autoPlay=true & loop=true }]{}{VPlayer.swf}
    \column{.5\textwidth}
      \includemedia[addresource=forward_facing_step_viscosity_movie.mp4, activate=pageopen, deactivate=pageclose, width=6.5cm, height=5cm, flashvars={source=forward_facing_step_viscosity_movie.mp4 & autoPlay=true & loop=true }]{}{VPlayer.swf}
  \end{columns}
\end{frame}
%************************************************
...
\item The SEM degenerates into the 5-equation model
\end{itemize}
\end{block}
\end{frame}
%************************************************
